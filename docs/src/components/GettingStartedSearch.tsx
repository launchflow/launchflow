...
const keywordColors = {
  ...
  java: 'inline-flex items-center rounded-md bg-amber-50 dark:bg-amber-400/10 px-2 py-1 text-xs font-medium text-amber-600 dark:text-amber-500 ring-1 ring-inset ring-amber-500/10 dark:ring-amber-400/20',
...
const cards = [
  ...
  {
    title: 'Spring Boot',
    href: '/docs/get-started/spring-boot',
    keywords: ['java', 'api'],
    logo: '/images/spring-boot.png',
  },
  {
    title: 'Docker',
