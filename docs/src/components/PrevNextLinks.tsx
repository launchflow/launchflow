    ...
    <div {...props}>
      ...
      <dd className="mt-1">
        <Link
          href={href}
          className={clsx(
            'flex items-center gap-x-1 text-base font-semibold text-slate-500 hover:text-slate-600 dark:text-slate-300 dark:hover:text-slate-300',
...
export function PrevNextLinks() {
  ...
  let allLinks = homeNavigation.flatMap((section) => section.links)
