    ...
    <div>
      <div className="hidden md:block">
        <Listbox as="div" value={theme} onChange={setTheme} {...props}>
          ...
          <Listbox.Options className="absolute left-1/2 top-full mt-3 w-36 -translate-x-1/2 space-y-1 rounded-xl bg-white p-3 text-sm font-medium shadow-md shadow-black/5 ring-1 ring-black/5 dark:bg-background_dark dark:ring-white/5">
            {themes.map((theme) => (
              <Listbox.Option
                key={theme.value}
                value={theme.value}
              ...
              >
                {({ selected }) => (
                  <>
                    <div className="rounded-md bg-white p-1 shadow ring-1 ring-background_dark/5 dark:bg-background_dark dark:ring-inset dark:ring-white/5">
                      <theme.icon
                        className={clsx(
                          'h-4 w-4',
                          selected
