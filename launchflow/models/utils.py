...
from launchflow.gcp.cloud_run_service import CloudRunService, CloudRunServiceContainer
...
SERVICE_PRODUCTS_TO_SERVICES = {
    DeploymentProduct.UNKNOWN.value: Deployment,
    # AWS product types
    DeploymentProduct.AWS_ECS_FARGATE_SERVICE.value: ECSFargate,
    # GCP product types
    DeploymentProduct.GCP_CLOUD_RUN_SERVICE.value: CloudRunService,
    DeploymentProduct.GCP_COMPUTE_ENGINE_SERVICE.value: ComputeEngineService,
}
